...
def addMuNuJetSimpleEventTree(process,name,src = 'wCandsSel', srcLL = 'diMuonsSorted',srcJets='smearedJetsMNJ',srcMuons='vetoPatMuons10',srcElectrons='vetoPatElectrons10'):
   ...
   eventTree = cms.EDAnalyzer('EventTreeMaker',
				    ...
				    tag        = cms.string("isoMuRho"),
                              ...
                              nJetsSize = cms.PSet(
                                  ...
                                  method     = cms.string('pt()>30 && abs(eta())<2.5'),
                              ),
                              nJetsSize2 = cms.PSet(
                                  pluginType = cms.string("PATMuonNuPairJetCountFiller"),
                                  src        = cms.InputTag(src),
                                  tag        = cms.string("nJets20"),
				  method= cms.string('pt()>20 && abs(eta())<2.5'),
                              ),
                              nJetsSize3 = cms.PSet(
                                  pluginType = cms.string("PATMuonNuPairJetCountFiller"),
                                  src        = cms.InputTag(src),
                                  tag        = cms.string("nJets40"),
                                  method     = cms.string('pt()>40 && abs(eta())<2.5'),
                              ),
...
def addEleNuJetSimpleEventTree(process,name,src = 'wCandsSelEle', srcLL = 'diElecsSorted',srcJets='smearedJetsENJ',srcMuons='vetoPatMuons10',srcElectrons='vetoPatElectrons10'):
   process.TFileService = cms.Service("TFileService", fileName = cms.string("analysis.root") )
   eventTree = cms.EDAnalyzer('EventTreeMaker',
                              coreCollections = cms.VInputTag(
                                   cms.InputTag(src)
			...
			leadingOnly=cms.untracked.bool(True)
                ...
                eleWWID = cms.PSet(
                        ...
                        leadingOnly=cms.untracked.bool(True)
                              ...
                              ptEle2 = cms.PSet(
                                  pluginType = cms.string("PATElectronNuPairFiller"),
                                  src        = cms.InputTag(src),
                                  tag        = cms.string("ptEleUp"),
                                  method     = cms.string("lepton.userCand('ees+').pt()"),
                                  leadingOnly=cms.untracked.bool(True)
                              ),
                             ptEle3 = cms.PSet(
                                  pluginType = cms.string("PATElectronNuPairFiller"),
                                  src        = cms.InputTag(src),
                                  tag        = cms.string("ptEleDown"),
                                  method     = cms.string("lepton.userCand('ees-').pt()"),
                                  leadingOnly=cms.untracked.bool(True)
                              ),
				...
				ptEleZ2 = cms.PSet(
                              ...
                              nJetsSize = cms.PSet(
                                  ...
                                  src        = cms.InputTag(src),
                                  tag        = cms.string("nJets"),
                                  method     = cms.string('pt()>25 && abs(eta)<2.5'),
                              ),
                              nJetsSize2 = cms.PSet(
                                  pluginType = cms.string("PATElectronNuPairJetCountFiller"),
                                  src        = cms.InputTag(src),
				  ...
				  method= cms.string('pt()>20 && abs(eta)<2.5'),
                              ...
                              nJetsSizeSSV = cms.PSet(
                                  ...
                                  method     = cms.string('pt()>25 && abs(eta)<2.5&&bDiscriminator("simpleSecondaryVertexHighEffBJetTags")>1.19'),
                              ),
                              jetpt1 = cms.PSet( 
                                    pluginType = cms.string("PATJetFiller"),
                                    src        = cms.InputTag(srcJets),
...
#                                   verbose   =cms.untracked.bool(True),
#                                   tag= cms.string("pdfweight_mstw2008nlo"),
...
#                              ),
                              ...
                              jetPUID2 = cms.PSet(
                                    pluginType = cms.string("PATJetFiller"),
                                    src        = cms.InputTag(srcJets),
                                    tag        = cms.string("jetPUIDSimple"),
                                    method     = cms.string("userInt('simpleIdLoose')"),
                                    leadingOnly=cms.untracked.bool(True)
                              ),
