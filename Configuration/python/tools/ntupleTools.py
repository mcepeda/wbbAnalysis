...
from UWAnalysis.Configuration.tools.analysisToolsPT import TriggerPathsPT
...
def addMuTauEventTree(process,name,src = 'diTausTauMuonVeto', srcLL = 'diMuonsSorted'):
   ...
   eventTree = cms.EDAnalyzer('EventTreeMaker',
                              ...
                              muTauWWID = cms.PSet(
                                  ...
                                  method     = cms.string('leg1.userInt("WWID")'),
                                  leadingOnly=cms.untracked.bool(True)
                              ),
                              muTauMVAID = cms.PSet(
                                  pluginType = cms.string("PATMuTauPairFiller"),
                              ...
                              muTauRelPFIsoDB = cms.PSet(
                                  ...
                                  method     = cms.string('(leg1.chargedHadronIso+max(leg1.photonIso()+leg1.neutralHadronIso()-0.5*leg1.puChargedHadronIso,0.0))/leg1.pt()'),
                                  leadingOnly=cms.untracked.bool(True)
                              ),
...
#                               ),
                              ...
                              eleTauPFRelIsoDB = cms.PSet(
                                  ...
                                  src = cms.InputTag(src),
                                  tag =cms.string("lPfRelIsoDeltaBeta"),
                                  method =cms.string('leg1.isEB()*(leg1.chargedHadronIso+max(leg1.photonIso+leg1.neutralHadronIso-0.5*leg1.puChargedHadronIso,0.0))/leg1.pt()+leg1.isEE()*(leg1.chargedHadronIso+max(leg1.userIso(1)+leg1.neutralHadronIso-0.5*leg1.puChargedHadronIso,0.0))/leg1.pt()'),
                                  leadingOnly=cms.untracked.bool(True)
                                  ),
