...
MNJanalysisConfigurator.addSmearing('cleanPatTaus','cleanPatMuons','calibratedPatElectrons','patJetsForAnalysis','systematicsMET','default','MNJ')
...
ENJanalysisConfigurator.addSmearing('cleanPatTaus','cleanPatMuons','calibratedPatElectrons','patJetsForAnalysis','systematicsMET','default','ENJ')
...
ENJanalysisConfigurator.addSelector('diElecsSel','PATElePairSelector',DiElePreSel+'&&'+DiElePreSel2+'&&'+DiElePreSel3,'diElecsSel',0,0)
ENJanalysisConfigurator.addSorter('diElecsSorted','PATElePairSorter')

#Make Elecs+MET
ENJanalysisConfigurator.addCandidateMETModule('wCandsEle','PATElectronNuPairProducer','smearedElectronsENJ','smearedMETENJ','smearedJetsENJ',1,9999,'AtLeastOneWCandidateELE',genParticles="genDaughters")
