...
#Make Muons+MET
MNBBanalysisConfigurator.addCandidateMETModule('wCands','PATMuonNuPairProducer','cleanPatMuons','systematicsMET','patJetsForAnalysis',0,9999,'AtLeastOneWCandidate',genParticles="genDaughters")
#MNBBanalysisConfigurator.addSelector('wCandsTight','PATMuonNuPairSelector',munuTight,'tightID',1)
MNBBanalysisConfigurator.addSelector('wCandsKIN','PATMuonNuPairSelector',munuKIN,'wCandsKIN',0,999)
MNBBanalysisConfigurator.addSelector('wCandsSel','PATMuonNuPairSelector',munuSel,'wCandsSel',0,999)
...
#Make Di Jets
MNBBanalysisConfigurator.addDiCandidateModule('diJets','PATJetPairProducer', 'patJetsForAnalysis','patJetsForAnalysis','systematicsMET','patJetsForAnalysis',0,9999,leadingObjectsOnly = True,dR = 0.5,recoMode = "",genParticles = "genDaughters")
MNBBanalysisConfigurator.addSelector('diJetsKIN','PATJetPairSelector',jetKIN,'JetEtKIN',0,999)
MNBBanalysisConfigurator.addSelector('diJetsSel','PATJetPairSelector','','JetEtSel',0,999)
MNBBanalysisConfigurator.addSorter('diJetsSorted','PATJetPairSorter')


# Try 4-Object
MNBBanalysisConfigurator.addDiCandidateModule('fourObject','PATMuNuJetJetQuadProducer', 'wCandsSel','diJetsSorted','systematicsMET','patJetsForAnalysis',0,9999,leadingObjectsOnly = True,dR = 0.5,recoMode = "",genParticles = "genDaughters")
