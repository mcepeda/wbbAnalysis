...
/*
      ...
      //
      t->SetBranchAddress("jet1PartonFlavour",&J1Parton);
...
*/
      ...
      // Maria's trees (I will move my labeling...)	
      t->SetBranchAddress("ptMu",&pt);
      t->SetBranchAddress("etaMu",&eta);
      //
      t->SetBranchAddress("jet1PartonFlavour",&J1Parton);
      t->SetBranchAddress("jet2PartonFlavour",&J2Parton);

      t->SetBranchAddress("jet1pt",&j1pt);
      t->SetBranchAddress("jet2pt",&j2pt);

      t->SetBranchAddress("jet1eta",&j1eta);
      t->SetBranchAddress("jet2eta",&j2eta);

      t->SetBranchAddress("jet1BTag_CSV",&J1CSVbtag);
      t->SetBranchAddress("jet2BTag_CSV",&J2CSVbtag);

      t->SetBranchAddress("jet1BTag_SSVHE",&J1SSVHEbtag);
      t->SetBranchAddress("jet2BTag_SSVHE",&J2SSVHEbtag);
